...
! function(a) {
    ...
    a.extend(a.FE.POPUP_TEMPLATES, {
        ...
        function i() {
            ...
            if (Da)
                for (c = 0; c < Da.length; c++) e.indexOf(Da[c].getAttribute("src")) < 0 && b.events.trigger("image.removed", [a(Da[c])]);
            Da = d
        }
        ...
        function D(c, d, e) {
            ...
            var i = a('<a href="'+c+'"><img class="' + (b.opts.imageDefaultDisplay ? "fr-di" + b.opts.imageDefaultDisplay[0] : "") + (b.opts.imageDefaultAlign && "center" != b.opts.imageDefaultAlign ? " fr-fi" + b.opts.imageDefaultAlign[0] : "") + '" src="' + c + '"' + g + (h ? ' style="width: ' + h + ';"' : "") + "></a>");
        ...
        function U(a) {
            ...
            if (qa || b.opts.toolbarInline) qa && (d = qa.offset().top + qa.outerHeight());
            else {
