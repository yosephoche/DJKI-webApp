		...
		<div class="row">
			<div class="container">
				<ul class="nav nav-tabs">
					<li role="presentation"><a href="{{ route('posts_editID', $posts->id) }}">Indonesia</a></li>
					<li role="presentation" class="active"><a href="{{ route('posts_editEN', $posts->id) }}">English</a></li>
				</ul>
			</div>
			<div class="col-md-12">
				<div class="panel">
